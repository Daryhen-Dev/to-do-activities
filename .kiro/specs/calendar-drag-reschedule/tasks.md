...
- [x] 1. Add reschedule helpers to `src/lib/calendar.ts`
...
- [x] 2. Unit-test the reschedule helpers
...
- [x] 3. Add pointer-drag to the TimeGrid
...
- [x] 4. Add the reschedule handler in CategoryCalendar
