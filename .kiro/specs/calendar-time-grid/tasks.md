...
- [x] 1. Add week/day helpers and the day layout to `src/lib/calendar.ts`
...
- [x] 3. Make store navigation view-aware in `src/stores/calendar-store.ts`
...
- [x] 4. Unit-test the view-aware navigation
...
- [x] 5. Build the TimeGrid component
...
- [x] 6. Wire the toolbar and container for week/day
