...
- [ ] 1. Add scheduling fields to the Prisma schema
...
- [ ] 2. Write the scheduling migration
...
- [ ] 4. Add schedule fields to the planning-item validators
...
- [ ] 5. Extend the planning-item repository for schedule fields
...
- [ ] 6. Add schedule validation and wiring in the service
...
- [ ] 7. Backend tests for scheduling validation
...
- [ ] 8. Add the category range query to the repository
...
- [ ] 9. Add the range service with ownership check
...
- [ ] 10. Add the category calendar route
...
- [ ] 12. Add schedule controls to the task edit dialog
